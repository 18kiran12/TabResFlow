...
class JoblibStudy:
    ...
    def _optimize_study(self, func, n_trials, **optimize_parameters):
        ...
        study.optimize(func, n_trials=n_trials, **optimize_parameters, n_jobs=1) # explicitly mentioned
    ...
    def optimize(self, func, n_trials=1, n_jobs=-1, **optimize_parameters):
        ...
        if n_jobs == 1:
            self._optimize_study(func, n_trials=n_trials, **optimize_parameters)
        else:
